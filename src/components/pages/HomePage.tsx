...
export default function HomePage({ lang }: { lang: Lang }) {
  ...
  const aboutCards = getAboutCards(lang);
    ...
    <div className="mx-auto max-w-5xl px-6 lg:pr-40">
      ...
      <FadeInSection>
        <section id="about" className="scroll-mt-24 py-16">
          <SectionHeading lang={lang} heading={t.home.about} />
          <div className="mt-10 grid gap-8 lg:grid-cols-[1fr_320px]">
            ...
            <div className="flex flex-col gap-6">
              <PersonalDetailsCard lang={lang} />
              <div className="rounded-2xl border border-white/10 bg-card p-6">
                <h3 className="text-lg font-semibold">{t.currently}</h3>
      ...
      <FadeInSection>
        <section id="skills" className="scroll-mt-24 py-16">
          <SectionHeading lang={lang} heading={t.home.skills} />
      ...
      <FadeInSection>
        <section id="projects" className="scroll-mt-24 py-16">
          <SectionHeading lang={lang} heading={t.home.projects} />
                ...
                <div className="flex items-center justify-between">
                  ...
                  {project.status && (
                    <span className="rounded-full border border-brand-yellow/40 px-2.5 py-1 text-xs font-medium text-brand-yellow">
                      {getStatusLabel(lang, project.status)}
                    </span>
                  )}
                </div>
      ...
      <FadeInSection>
        <section className="py-16">
          <div className="flex items-baseline justify-between">
            <SectionHeading lang={lang} heading={t.home.writing} />
            <Link
  ...
  return (
    <div>
      <h2 className="text-2xl font-semibold tracking-tight">
        {heading.eyebrow}
        {/* Chinese sets its own spacing; a Latin word break would read as a gap. */}
        {lang === "en" ? " " : ""}
        <span className="text-brand-blue-light">{heading.title}</span>
      </h2>
