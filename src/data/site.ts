...
export const projects: Project[] = [
  {
    ...
    name: "Soulor AI",
    description:
      "Soulor is a companion app that remembers you. Memory and relationship stage reach generation itself, so a companion's voice shifts across five stages from stranger to soulmate — and the same engine runs simulation modes, for rehearsing a hard conversation before having it for real.",
    tags: [
      "Stateful Sampling",
  ...
  },
  {
    ...
    name: "VNportal",
    description:
      "VNportal is a vinyl and music platform built on real-time audio. Find a record, play what sits behind it, then mix it, cut it into a DAW, or play a rhythm game charted from its own detected beats — and generate single instruments, bar-locked to the tempo you set.",
    tags: [
      "Onset Charting",
      "Source Cascade",
      "Stem Synthesis",
      "Bar-Locked Generation",
    ],
