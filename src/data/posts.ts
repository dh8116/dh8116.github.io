...
const unsortedPosts: Post[] = [
  ...
  },
  {
    ...
    title: "The Leaderboard Changes Every Week, the Excitement Never Outlives Criticisms",
    date: "2026-09-12",
    excerpt:
      "Excitement arriving in an afternoon lasts only as long as a frontier model holds its ranking \u2014 one or two weeks on average, and you never test the model yourself.",
    paragraphs: [
